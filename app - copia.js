...
const state = {
  ...
  isAdmin: false,
  adminToken: null,
  adminTab: 'pending', // 'pending', 'rubros', 'listings', 'pharmacies', 'ads', 'security'
  pendingSubmissions: [],
...
function renderAdminModal() {
  ...
  return `
    <div class="modal-overlay">
      <div class="form-modal-content" style="max-width: 980px; width: 95%;">
        <button class="modal-close-btn" onclick="window.closeAdminModal()">✕</button>
        ...
        <tbody>
          ${state.pendingSubmissions.map(s => `
            <tr>
              ...
              <td>📞 ${s.telefono}</td>
              <td>
                <button class="btn btn-primary" style="padding: 4px 8px; font-size: 0.78rem;" onclick="window.approveSubmission('${s.id}', 'gratuito')">Gratis</button>
                <button class="btn btn-outline" style="padding: 4px 8px; font-size: 0.78rem; border-color: var(--primary);" onclick="window.approveSubmission('${s.id}', 'plata')">Plata</button>
                <button class="btn btn-whatsapp" style="padding: 4px 8px; font-size: 0.78rem;" onclick="window.approveSubmission('${s.id}', 'oro')">Oro VIP</button>
                <button class="btn btn-outline" style="padding: 4px 8px; font-size: 0.78rem; color: red;" onclick="window.rejectSubmission('${s.id}')">Rechazar</button>
              </td>
            </tr>
          `).join('')}
        </tbody>
...
// Pestaña Admin: Gestión de Rubros
